                ...
                <div className={`py-2 px-8 flex flex-col mx-auto border border-t-2 border-b-2 ${theme === "light" ? "border-slate-300" : "bg-[#2f323a] border-[#212329] "} z-1`}>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <div className="relative">
                            <select name="type" id="Property type" className={`appearance-none w-auto md:w-72 leading-7 border-2 rounded-md ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring-2 focus:ring-indigo-600 focus:border-transparent pl-3 pr-10 py-2`} defaultValue={property.type}>
                                {/* options */}
                            </select>
                            <div className={`pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700 ${theme === "light" ? "" : "text-gray-300"}`}>
                                <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path d="M5.516 7.548c.436-.446 1.043-.481 1.576 0 .533.481 1.576 1.576 2.109 2.108l.927.927c.482.482.927.482 1.41 0l.927-.927c.533-.532 1.576-1.627 2.108-2.108.533-.481 1.141-.446 1.576 0 .436.445.408 1.182 0 1.615l-3.66 3.66c-.482.482-.927.482-1.41 0l-3.66-3.66c-.408-.433-.436-1.17 0-1.615z" />
                                </svg>
                            </div>
                        </div>
                    </div>
