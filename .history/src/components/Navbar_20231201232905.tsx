...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 w-full ${theme === "light" ? "navbarLight" : "navbarDark"} font-Noto text-lg md:shadow-sm shadow-slate-100 flex items-center md:justify-between h-14`}>
