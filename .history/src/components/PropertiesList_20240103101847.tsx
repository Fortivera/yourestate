            ...
            <div className={`w-full h-full pt-1 border-b-2 md:border-r-2 ${theme === "light" ? "bg-slate-600/10 border-[#e4e7ec]" : "propertyListDark border-[#536079]"}    shadow-neutral-400 shadow-sm overflow-auto`}>
                <div className="flex mx-4 font-Noto text-base  ">
                    <div className=" relative">
                        ...
                        <input type="text" value={searchedData} className={`${theme === "light" ? "bg-slate-50" : "bg-slate-500/60"} block w-full p-4 ps-10 text-sm outline-none border-[1px] border-slate-200 rounded-lg mt-1 mb-1 h-8`} placeholder="Search..." onChange={handleChange} />
                        {searchedData && (
                            <button
