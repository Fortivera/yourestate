...
export default function Property({ property }: Props) {
  ...
  return (
    <div className={`flex flex-col mx-3 py-2 rounded-md font-Noto text-base ${theme === "light" ? "hover:bg-slate-200" : "hover:bg-slate-700 /60 border-b-gray-400"} `} key={property.id}>
