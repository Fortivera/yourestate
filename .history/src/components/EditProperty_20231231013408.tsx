        ...
        <Modal>
            ...
            <form method="PUT" id="update-form" onSubmit={handleSubmit}>
                <div className={`py-2 px-8 flex flex-col mx-auto border border-t-2 border-b-2 ${theme === "light" ? "border-slate-300" : "bg-[#2f323a] border-[#212329]"} z-1`}>
                    ...
                    <input hidden defaultValue={property.id} type="text" name="id" className={`${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"}`} />
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="text" name="suite" aria-label="Suite" defaultValue={property.suite} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="text" name="postalCode" aria-label="PostalCode" defaultValue={property.postalCode} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="text" name="city" aria-label="City" defaultValue={property.city} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="text" name="province" aria-label="Province" defaultValue={property.province} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="text" name="country" aria-label="Country" defaultValue={property.country} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="number" name="tenant" aria-label="Tenants" defaultValue={property.tenant} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="number" name="rent" aria-label="Rent" defaultValue={property.rent} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="number" name="surfaceArea" aria-label="Surface area" defaultValue={property.surfaceArea} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="number" name="age" aria-label="Age" defaultValue={property.age} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="number" name="electricity" aria-label="Electricity" defaultValue={property.electricity} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="number" name="hydro" aria-label="Hydro" defaultValue={property.hydro} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`w-full md:w-72 leading-7 rounded-md shadow-sm ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring focus:ring-indigo-500 focus:ring-opacity-50`} id="" type="number" name="gas" aria-label="Gas" defaultValue={property.gas} />
                    </div>
