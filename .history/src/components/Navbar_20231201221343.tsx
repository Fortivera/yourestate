...
export default function Navbar() {
  ...
  return (
    <nav className={`${theme === "light" ? "navbarLight" : "navbarDark"} font-Noto text-lg shadow-sm shadow-slate-100 flex items-center justify-between h-14`}>
      ...
      {/* Burger Menu */}
      <button className="block md:hidden cursor-pointer p-2 mr-1.5" onClick={handleMenuToggle}>
      ...
      <div className={`md:hidden ${menuOpen ? "flex" : "hidden"} space-y-3 relative top-5 bg-white opacity-90 z-10`}>
