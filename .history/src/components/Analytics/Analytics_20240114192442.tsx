...
export const Analytics = () => {
    ...
    return (
        <>
            ...
            <div className={`${theme === "light" ? "bg-slate-50 border-t-2 shadow-darkInner shadow-[#ffffff] border-[#fffcfa]" : "bg-[#515F73] border-[#5f6c80] shadow-darkInner"} flex-grow w-full h-screen py-2 px-1 font-Poppins border-t-2 md:border-hidden md:shadow-sm md:overflow-y-auto`}>
                {/* <div className="flex bg-slate-400 gap-8 mx-auto justify-center items-center px-2">
                    <div className="w-56 rounded-sm  ">Analytics</div>
