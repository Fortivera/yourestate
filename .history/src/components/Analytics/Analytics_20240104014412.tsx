...
export const Analytics = () => {
    ...
    return (
        <>
            ...
            <div className={`${theme === "light" ? "bg-slate-50 border-t-2 shadow-darkInner shadow-[#ffffff] border-[#fffcfa]" : "bg-[#515F73] border-[#5f6c80] shadow-darkInner"} flex w-full py-2 px-1 font-Poppins border-t-2 md:border-hidden md:shadow-sm`}>
