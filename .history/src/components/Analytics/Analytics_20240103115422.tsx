...
export const Analytics = () => {
    ...
    return (
        <>
            ...
            <div className={`${theme === "light" ? "bg-slate-50 border-[#e4e7ec]" : "bg-[#515F73] border-[#536079]"} grid grid-cols-1 border-t-[#4d576a] shadow-darkInner  desktop:grid-cols-2 w-full py-2 px-1 font-Poppins border`}>
                <div>
