    ...
    return (
        <>
            ...
            <div className={`${theme === "light" ? "bg-slate-50 border-t-2 shadow-darkInner shadow-[#ffffff] border-[#fffcfa]" : "bg-[#515F73] border-[#5f6c80] shadow-darkInner"}  w-full h-screen py-2 px-1 font-Poppins border-t-2 md:border-hidden md:shadow-sm md:overflow-y-auto`}>
                <div className="flex bg-slate-500 gap-8 mx-auto justify-center items-center px-2">
                    <div className="w-56 rounded-sm border-r-2">Analytics</div>
                    <div className="w-56 rounded-sm border-x-2">Amount of housed people 123444</div>
                    <div className="w-56  rounded-sm">|Annual profit|</div>
                </div>
