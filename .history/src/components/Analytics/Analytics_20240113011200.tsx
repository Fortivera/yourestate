    ...
    return (
        <>
            ...
            <div className={`${theme === "light" ? "bg-slate-50 border-t-2 shadow-darkInner shadow-[#ffffff] border-[#fffcfa]" : "bg-[#515F73] border-[#5f6c80] shadow-darkInner"}  w-full h-screen py-2 px-1 font-Poppins border-t-2 md:border-hidden md:shadow-sm md:overflow-y-auto`}>
                <div className="  flex gap-8 mx-auto justify-center px-2">
                    <div className="w-56 bg-slate-100 rounded-sm">monthly rent income</div>
                    <div className="w-56 bg-slate-100 rounded-sm">Amount of housed people</div>
                    <div className="w-56 bg-slate-100 rounded-sm">Annual profit</div>
                </div>
