...
export const Analytics = () => {
    ...
    return (
        <>
            ...
            <div className={`${theme === "light" ? "bg-slate-50 border-[#e4e7ec]" : "bg-[#515F73] border-[#5f6c80]"} grid grid-cols-1  shadow-darkInner  desktop:grid-cols-2 w-full py-2 px-1 font-Poppins border-2`}>
                <div>
