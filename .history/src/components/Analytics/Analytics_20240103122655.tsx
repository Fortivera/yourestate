...
export const Analytics = () => {
    ...
    return (
        <>
            ...
            <div className={`${theme === "light" ? "bg-slate-50 shadow-darkInner shadow-[#e7eaee] border-[#5a697e]" : "bg-[#515F73] border-[#5f6c80] shadow-darkInner"} grid grid-cols-1    desktop:grid-cols-2 w-full py-2 px-1 font-Poppins border-t-2 md:border-hidden md:shadow-sm`}>
                <div>
