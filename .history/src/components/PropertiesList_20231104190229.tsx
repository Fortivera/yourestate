...
export default function PropertiesList({ allProperties }: Props) {
  ...
  return (
    <>
      <div className={`w-screen md:w-[350px] pt-1 border-b-2 border-r-2 ${theme === "light" ? "propertyListLight" : "propertyListDark"} border-gray-200   shadow-neutral-400 shadow-sm overflow-auto`}>
