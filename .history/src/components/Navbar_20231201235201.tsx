...
export default function Navbar() {
  ...
  return (
    <nav className={`w-full ${theme === "light" ? "navbarLight" : "navbarDark"} flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8`}>
      ...
      <div className={`md:hidden ${menuOpen ? "flex" : "hidden"} flex-col flex-grow pb-4 md:pb-0 md:flex md:justify-end md:flex-row hidden `}>
        <div className="">
          <ThemeToggle />
          <Link href={"dashboard/createproperty"}>
            <div className="h-10 flex items-center px-3">
