...
export default function PropertiesList() {
    ...
    const isDataEmpty = allProperties && allProperties.length === 0
    const EmptyDataComponent = () => <div className={`flex justify-center items-center h-40 text-lg italic  ${theme === "light" ? "text-[#f5f5f599]" : "text-[#f5f5f599]"}`}>Create New Properties</div>
