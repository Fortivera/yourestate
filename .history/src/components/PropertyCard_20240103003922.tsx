...
export default function PropertyCard({ property }: Props) {
    ...
    ${theme === "light" ? "bg-[#dee3e88a] border-[1px] border-b-[2px] border-[#cbccce] shadow-sm   hover:bg-[#cbccce]hover:shadow-none" : "bg-neutral-900/20 border-[1px] border-b-[2px] border-[#5e6775] shadow-darkSm   hover:bg-neutral-800 hover:shadow-none hover:border-[#222222]"}`}
        >
            <div className="py-2">
