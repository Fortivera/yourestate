...
export const CustomDropdown = ({ options, theme }: any) => {
    ...
    return (
        <div className={"relative inline-block text-left w-auto md:w-72"}>
            ...
            {isOpen && (
                <div className={`${theme === "light" ? "bg-white text-black" : "bg-[#a6a9b3fd]  text-white"} origin-top-right absolute right-0 mt-2 w-full rounded-md shadow-lg  ring-1  ring-black ring-opacity-20 focus:outline-none`}>
                    <div className="py-1">
