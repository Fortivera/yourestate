    ...
    async function handleSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (parsedData.success) {
                ...
                toast.custom((t) => <div className={`${theme === "light" ? "bg-white" : "bg-slate-500"} px-6 py-4 shadow-md rounded-full ${t.visible ? "animate-enter" : "animate-leave"} duration-75`}>Property updated successfully! 👋</div>)
                router.replace("/dashboard")
            } else {
