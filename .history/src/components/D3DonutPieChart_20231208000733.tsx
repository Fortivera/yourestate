...
export const D3DonutPieChart: React.FC<Props> = ({ allProperties }: Props) => {
    ...
    const createPieChart = (data: Property[], theme: string) => {
        ...
        const legendDiv = d3.select('body').append('div')
            .attr('class', 'legend')
            .style('overflow-y', 'scroll')
            .style('height', '300px') // Adjust the height to fit your needs
            .style('width', '150px'); // Adjust the width to fit your needs

        // Append your legend items to the div
