            ...
            <form method="PUT" id="update-form" onSubmit={handleSubmit}>
                <div className="  py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <select name="Type" id="Property type" className={`leading-7 w-auto md:w-72 border-b-2 ${theme === "light" ? "bg-white" : inputColour} w-auto md:w-72`} defaultValue={property.type}>
