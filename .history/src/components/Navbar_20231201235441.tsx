...
export default function Navbar() {
    ...
    return (
        <nav className={`w-full ${theme === "light" ? "navbarLight" : "navbarDark"} font-Noto text-lg md:shadow-sm shadow-slate-100 flex flex-col md:justify-between md:items-center md:flex-row h-14  top-0`}>
            ...
            <div className={`md:hidden ${menuOpen ? "flex" : "hidden"} flex-col flex-grow pb-4 md:pb-0 md:flex md:justify-end md:flex-row `}>
                <div className="">
                    <ThemeToggle />
                    <Link href={"dashboard/createproperty"}>
                        <div className="h-10 flex items-center px-3">
