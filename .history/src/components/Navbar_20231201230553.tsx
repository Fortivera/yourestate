...
export default function Navbar() {
    ...
    return (
        <nav className={`w-full ${theme === "light" ? "navbarLight" : "navbarDark"} font-Noto text-lg shadow-sm shadow-slate-100 flex items-center justify-between h-14 fixed shadow-none top-0 z-50`}>
