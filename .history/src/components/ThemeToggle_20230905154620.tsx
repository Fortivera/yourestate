...
export default function ThemeToggle() {
    ...
    return (
        <div className="flex items-center w-14 h-6 rounded-full cursor-pointer justify-between  relative" onClick={toggle}
            style={
            ...
            <div className="rounded-full w-5 h-5 absolute m-0.5"
                style={
