...
interface props{
    existingDefaultValues?: Property
}
...
export default function FormInput(existingDefaultValues: Property) {
                ...
                return (
                    <div key={entity.id} className="flex flex-col md:flex-row py-2 ">
                        ...
                        <input
                            ...
                            {...entity} defaultValue={entity.label === existingDefaultValues.? existingDefaultValues.}
                            required
