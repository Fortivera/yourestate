...
export const CustomDropdown = ({ options, theme }: any) => {
    ...
    return (
        <div className={"relative inline-block text-left w-auto md:w-72"}>
            ...
            <div
                className={`${theme === "light" ? "bg-white border-2 border-[#9da0a63d] text-black focus:border-[#47444422] focus:ring-blue-400 focus:ring-2" : "bg-[#767a8572] border-2 border-[#595c653d] text-white focus:border-[#bab2b291]"}
                          text-base rounded-[15.125px] pl-1 p-[1.5px] leading-7 inline-flex justify-between items-center w-full selection:ring-1`}
