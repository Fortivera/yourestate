...
export default function PropertiesList() {
    ...
    return (
        <>
            <div className={`w-full h-full pt-1 border-b-2 md:border-r-2 ${theme === "light" ? "bg-slate-100" : "propertyListDark"} border-gray-200   shadow-neutral-400 shadow-sm overflow-auto`}>
