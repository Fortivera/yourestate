...
export default function Navbar() {
    ...
    return (
        <>
            <nav className={`w-full ${theme === "light" ? "navbarLight" : "navbarDark border-b-[#44464da9] shadow-lg"} font-Noto text-lg   flex  justify-between h-14 border-b- top-0 fixed z-50`}>
