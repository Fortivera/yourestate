    ...
    return (
        ...
        >
            <div className="flex items-center  ">
                <svg aria-label="React Router logo, nine dots in an upward triangle (one on top, two in the middle, three on the bottom) with a path of three highlighted and connected from top to bottom" class="h-14 w-14 md:h-12 md:w-12"><use href="/build/_assets/icons-UIZOAPCC.svg#logo"></use></svg>
                <svg width="208" height="52" xmlns="http://www.w3.org/2000/svg" overflow="hidden"  >
                    <g transform="translate(-284 -45)">
                        <text fill="currentColor" font-family="Segoe UI Black" font-weight="800" font-size="30" transform="translate(299.215 80)">YourEstate</text>
                    </g>
                </svg>
            </div>
