            ...
            <form method="PUT" id="update-form" onSubmit={handleSubmit}>
                <div className={`py-2 px-8 flex flex-col mx-auto border border-t-2 border-b-2 ${theme === "light" ? "border-slate-300" : "bg-[#2f323a] border-[#212329] "} z-1`}>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <div className={`${theme === "light" ? "bg-white" : "bg-[#767a8572]"} relative border-2 ${theme === "light" ? "border-[#9da0a63d]" : "border-[#595c653d]"} rounded-lg w-auto md:w-72`}>
                            <select name="type" id="Property type" className={`block appearance-none w-full text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 p-[3px] leading-7 ${theme === "light" ? "text-black" : "text-white"}`} defaultValue={property.type}>
                                <option value="House">House</option>
                                <option value="Land">Land</option>
                                <option value="Farm">Farm</option>
                                <option value="Parking">Parking</option>
                            </select>
                            <div className="absolute bottom-0 left-0 w-full h-1 bg-[#9da0a63d]"></div>
                        </div>
                    </div>
                    <div className="flex flex-col md:flex-row py-2 ">
