...
export const CustomDropdown = ({ options, theme }: any) => {
    ...
    return (
        <div className={"relative inline-block text-left w-auto md:w-72"}>
            ...
            <div
                className={`${theme === "light" ? "bg-white border-2 border-[#9da0a63d] text-black focus:border-[#47444422] focus:ring-blue-400" : "bg-[#767a8572] border-2 border-[#595c653d] text-white focus:border-[#bab2b291]"}
