...
export default function Navbar() {
    ...
    return (
        <>
            ...
            {/* Mobilie Navbar */}
            <div className={`md:hidden ${menuOpen ? "flex" : "hidden"} ${theme === "light" ? "navbarLight" : "navbarDark bg-green-100"} relative w-full z-50`}>
                <div className="flex flex-col  bg-gray-50 absolute right-0 border">
                    <ThemeToggle />
                    <Link href={"dashboard/createproperty"}>
                        <div className="h-10 flex items-center px-3">
                            <SvgAddProperty className="m-1" strokeWidth={1.5} />
