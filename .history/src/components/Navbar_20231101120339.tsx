      ...
      <div className="flex items-center  ">
        <div className="flex w-full items-center justify-between gap-8 md:w-auto">
          <div className="flex items-center gap-1 ">
            <Image src="/static/mainlogo.svg" alt="main logo" height="40" width="42" className=" md:h-12 md:w-12 pt-[6px] pl-2" />
          </div>
        </div>
        <Image src="/static/companyname.svg" width="163" height="52" />
