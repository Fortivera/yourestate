...
export const D3PieChart: React.FC<Props> = ({ allProperties }: Props) => {
    ...
    const createPieChart = (data: Property[]) => {
        ...
        const legendItems = legend
            ...
            .attr("data-type", (d) => d[0]) // Add data-type attribute for identification
            ...
            .on("click", function () {
                ...
                legend.selectAll(".legend-item").classed("active-legend", false).selectAll(".dot").style("opacity", 1)
        ...
        const slice = g
            ...
            .on("click", function (event, d) {
                ...
                legend
                    .selectAll(`.legend-item[data-type="${clickedType}"]`)
                    .classed("active-legend", !isActive)
                    .selectAll(".dot")
                    .style("opacity", isActive ? 1 : 0.5)
