...
export default function Navbar() {
    ...
    return (
        <>
            <nav className={`w-full ${theme === "light" ? "navbarLight" : "navbarDark border-b-[#7e8188a9] shadow-lg"} font-Noto text-lg   flex  justify-between h-14 border-b-2 top-0 fixed z-50`}>
