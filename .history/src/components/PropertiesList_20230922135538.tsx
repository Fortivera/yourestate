...
export default function PropertiesList({ allProperties }: Props) {
  ...
  return (
    <>
      <div
        className={`w-[350px] pt-1 border-b-2 border-r-2 ${theme === "light" ? "propertyListLight" : "propertyListDark"
          } border-gray-200   shadow-neutral-400 shadow-sm overflow-auto`}
      >
        <div className="flex ml-2 font-Noto text-base  ">
          <div className="flex">
            <input
              type="text"
              className={`${theme === "light" ? "bg-slate-50" : "bg-slate-500/60"
                } relative pl-2 outline-none border-[1px] border-slate-200 rounded-lg mt-1 mb-1 h-8 w-full`}
              placeholder="Search..."
