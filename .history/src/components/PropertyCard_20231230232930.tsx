...
export default function PropertyCard({ property }: Props) {
    ...
    return (
        <div className={`flex flex-col px-3 rounded-md font-Noto text-base border-[1px] border-b-[2px] transition-all duration-400 ease-out ${theme === "light" ? "bg-[#dee3e88a] border-slate-300 shadow-sm hover:bg-slate-200 hover:shadow-inner hover:border-slate-400" : "bg-neutral-900/20 border-[#5e6775] shadow-darkSm hover:bg-[#23262b7f] hover:shadow-darkInner hover:border-[#23262b33]"} `}>
            <div className="py-2">
