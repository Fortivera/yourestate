            ...
            .on('click', function (event, d) {
                ...
                slice.selectAll('path')
                    ...
                    .style('opacity', function () {
                        const isSliceClicked = d3.select(this).classed('clicked');
                        return isSliceClicked ? 1 : 0.5;
                    });

                // Update opacity for all legend items based on the 'clicked' class
                legend.selectAll('text')
                    .style('opacity', function () {
                        const isLegendClicked = d3.select(this).classed('clicked');
                        return isLegendClicked ? 1 : 0.5;
                    });
            });
