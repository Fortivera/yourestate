...
export default function PropertiesList() {
    ...
    return (
        <>
            <div className={`w-full h-full pt-1 pl-1 border-b-2 md:border-r-2 ${theme === "light" ? "bg-slate-600/10 border-[#e4e7ec]" : "propertyListDark border-[#536079]"}    shadow-neutral-400 shadow-sm overflow-auto`}>
                <div className="flex mx-1 font-Noto text-base  ">
