    ...
    const createPieChart = (data: Property[]) => {
        ...
        const legend = svg
            ...
            .on("click", function (event, d: any) {
                ...
                // Update opacity based on the active class for both legend and pie chart
                updateOpacity()
            })
        ...
        const updateOpacity = () => {
            ...
            slice
                ...
                .transition()
                .duration(500)
                .style("opacity", (sliceData: any) => (sliceData.index === clickedIndex || d3.select(`#legend-${sliceData.index}`).classed("active") ? 1 : 0.5))
        }
