...
export const CustomDropdown = ({ options, theme }: any) => {
    ...
    return (
        <div className={`${theme === "light" ? "bg-white border-2 border-[#9da0a63d] text-black focus:ring-[#bdbdc2]" : "bg-[#767a8572] border-2 border-[#595c653d] text-white focus:ring-[#989898]"} leading-7 w-full md:w-72 rounded-lg p-[2px] focus:outline-none focus:ring-[2px]`}>
