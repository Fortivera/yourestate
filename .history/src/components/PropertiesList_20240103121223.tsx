            ...
            <div className={`w-full h-full px-1 pt-1  md:border-r-2 ${theme === "light" ? "bg-slate-600/10 border-[#e4e7ec]" : "propertyListDark border-[#536079]"}    shadow-neutral-400 shadow-sm overflow-auto`}>
                <div className="flex  font-Noto text-base  ">
                    <div className="w-full relative">
                        ...
                        <input type="text" value={searchedData} className={`${theme === "light" ? "bg-slate-50" : "bg-slate-500/60"} pl-8 outline-none border-[1px] border-[#96999f] rounded-lg mt-1 mb-1 h-10 w-full`} placeholder="Search..." onChange={handleChange} />
                        {searchedData && (
                            <button
