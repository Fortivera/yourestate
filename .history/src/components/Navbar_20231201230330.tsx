...
export default function Navbar() {
  ...
  return (
    <nav className={`w-full ${theme === "light" ? "navbarLight" : "navbarDark"} font-Noto text-lg shadow-sm shadow-slate-100 flex items-center justify-between h-14 fixed  outline-none top-0 z-50`}>
      ...
      <div className={`md:hidden ${menuOpen ? "flex" : "hidden"} space-y-3 z-10 items-start`}>
        <div className="">
          <ThemeToggle />
          <Link href={"dashboard/createproperty"}>
            <div className="h-10 flex items-center px-3">
