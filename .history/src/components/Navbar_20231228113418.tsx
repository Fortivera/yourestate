  ...
  return (
    <>
      <nav
        ...
        } font-Noto text-lg   flex  justify-between h-14 top-0 fixed z-50`}
      >
        <div className="flex items-center">
          <SvgMainLogo
            height="40"
            width="42"
            className="h-12 w-12 pt-[6px] pl-2"
          />
          <SvgLogoName
            fill="currentColor"
        ...
        <button
          ref={buttonRef}
          className="md:hidden cursor-pointer p-2 mr-1.5"
      ...
      <div
        ...
        }   w-full z-50 top-14 fixed transition-all duration-500 ease-in-out`}
      >
        <div
          className={`flex flex-col absolute right-0 border border-t-[#dddddda4] shadow-lg rounded-b-lg overflow-hidden backdrop-filter backdrop-blur-md ${
            theme === "light"
              ? "bg-gray-50 bg-opacity-50 text-gray-700"
        ...
        >
            ...
            <div
              ...
              className={`h-10 flex items-center px-3 ${
                theme === "light"
                  ...
                  : "text-blue-300 hover:bg-slate-500"
              }`}
            >
              <SvgAddProperty className="m-1" strokeWidth={1.5} />
              <div>Add Property</div>
          ...
          <Link href={"/"}>
            <div
              className={`h-10 flex items-center px-3 ${
                theme === "light"
                  ? "text-red-500 hover:bg-slate-200"
                  : "text-red-300 hover:bg-slate-500"
              }`}
            >
              <SvgLogout strokeWidth={2} className="m-1" />
              <div>Logout</div>
          ...
          >
            <SvgUser className="m-1" strokeWidth={1.5} />
            <div className="ml-1">Admin</div>
          </div>
        </div>
      </div>
