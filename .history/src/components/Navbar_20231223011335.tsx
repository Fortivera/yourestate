...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`w-full ${theme === "light" ? "navbarLight" : "navbarDark"} font-Noto text-lg md:shadow-sm shadow-slate-100 flex  justify-between h-14 top-0 fixed z-50`}>
      ...
      {/* Mobilie Navbar */}
      <div ref={menuRef} className={`md:hidden ${menuOpen ? "flex" : "hidden"} relative w-full z-50 top-14 transition-all duration-500 ease-in-out`}>
