    ...
    return (
        <Modal>
            ...
            <form method="PUT" id="update-form" onSubmit={handleUpdateSubmit}>
                <div className={`py-2 px-8 flex flex-col mx-auto border border-t-2 border-b-2 ${theme === "light" ? "bg-white border-[#ccced3]" : "bg-[#2f323a] border-[#212329] "} z-1 overflow-y-auto `}>
