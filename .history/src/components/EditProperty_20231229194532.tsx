    ...
    onSuccess: (data: any, variables: Property) => {
      ...
      const updatedCachedProperties = cachedProperties!.map((p) => {
        ...
        if (p.id === Number(updatedProperty.id)) {
          p.id = updateProperty number
  p.type = updateProperty string
  p.address = updateProperty string
  p.city = updateProperty string
  p.suite = updateProperty string
  p.postalCode = updateProperty string
  p.province = updateProperty string
  p.country = updateProperty string
  p.tenant = updateProperty number
  p.rent = updateProperty number
  p.surfaceArea: number
  p.age = updateProperty number
  p.electricity = updateProperty number
  p.hydro = updateProperty number
  p.gas = updateProperty number
