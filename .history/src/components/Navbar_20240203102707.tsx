...
export default function Navbar() {
    ...
    return (
        <>
            <nav className={`w-full ${theme === "light" ? "navbarLight" : "navbarDark border-b-[#44464da9] shadow-lg"} font-Noto text-lg   flex  justify-between h-14 border-b- top-0 fixed z-30`}>
                ...
                <div className={`hidden md:flex items-center`}>
                    <ThemeToggle />
                    <Link href={"dashboard/createproperty"} scroll={false}>
            ...
            {/* Mobilie Navbar */}
            <div ref={menuRef} className={`md:hidden ${menuOpen ? "flex" : "hidden"}   w-full z-50 top-14 fixed transition-all duration-500 ease-in-out`}>
