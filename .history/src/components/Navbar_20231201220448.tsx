...
export default function Navbar() {
    ...
    return (
        <nav className={`${theme === "light" ? "navbarLight" : "navbarDark"} font-Noto text-lg shadow-sm shadow-slate-100 flex items-center justify-between h-[1048px]`}>
            ...
            <div className={`md:hidden ${menuOpen ? "flex" : "hidden"} space-y-3 relative top-5 bg-gray-50`}>
