            ...
            <div className="flex items-center  ">
                <div className="flex w-full items-center justify-between gap-8 md:w-auto">
                    <div className="flex items-center gap-1 ">
                        ...
                        <svg className=" md:h-12 md:w-12" width="208" height="52" xmlns="http://www.w3.org/2000/svg" overflow="hidden" fill="currentColor" style={{ verticalAlign: 'middle', marginBottom: '-40px' }}>
