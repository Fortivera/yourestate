    ...
    return (
        <nav
            className={`${theme === 'light' ? 'navbarLight' : 'navbarDark'
                } font-Noto text-lg shadow-sm shadow-slate-100 flex items-center justify-between px-2`}
        >
            <div className="flex items-center  ">
                <div className="flex w-full items-center justify-between gap-8 md:w-auto">
                    <div className="flex items-center gap-1 ">

                        <svg className=" md:h-12 md:w-12 pt-[6px] pl-2" width=" " height="52" xmlns="http://www.w3.org/2000/svg" overflow="hidden" fill="currentColor"  >
