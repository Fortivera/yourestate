        ...
        <nav className={`${theme === "light" ? "navbarLight" : "navbarDark"} flex font-Noto text-lg shadow-sm shadow-slate-100`}>
            <div className="flex items-center justify-center">
                ...
                >
                    <defs>
                        <clipPath id="c_1">
                            <path d="M0,0H935V1210H0Z" />
                        </clipPath>
                        <clipPath id="c0">
                            <path d="M0,1210V0H935V1210Z" />
                        </clipPath>
                        <style type="text/css">{`text { white-space: pre; } path, image { pointer-events: none; } .s1{ font-size: 16.81px; font-family: Carlito_5; fill: #000; }`}</style>
                    </defs>
                    <path d="M0,0 L0,1210 L935,1210 L935,0 Z " fill="#FFFFFF" stroke="none" />
                    <g clipPath="url(#c_1)">
                        <text
                            clipPath="url(#c0)"
                            x="110.2"
                            y="126.3"
                            dx="0,-1.3,0,0,-.1,0,-.2,-.1,-.3,-.1"
                            className="s1"
                        >
                            YourEstate{' '}
                        </text>
                    ...
                    <style type="text/css">
                        {`@font-face { font-family: Carlito_5; src: url("fonts/Carlito_5.woff") format("woff"); }`}
                    </style>
                </svg>
            </div>
