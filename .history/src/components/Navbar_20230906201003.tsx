        ...
        <nav className={`${theme === "light" ? "navbarLight" : "navbarDark"}  font-Noto text-lg shadow-sm shadow-slate-100`}>
            <div className="flex justify-end pr-5  items-center">
                <svg width="208" height="52" xmlns="http://www.w3.org/2000/svg" overflow="hidden">
                    <g transform="translate(-284 -50)">
                        <text font-family="Calibri Light,Calibri Light_MSFontService,sans-serif" font-weight="300" font-size="24" transform="translate(299.215 80)">YourEstate</text>
                        <text font-family="Calibri Light,Calibri Light_MSFontService,sans-serif" font-weight="300" font-size="24" transform="translate(389.069 80)">e</text>
                    </g>
                </svg>
                <ThemeToggle />
