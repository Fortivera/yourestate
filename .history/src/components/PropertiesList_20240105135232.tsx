...
export default function PropertiesList() {
    ...
    const EmptyDataComponent = () => <div className={`flex justify-center items-center h-40 text-lg italic  ${theme === "light" ? "text-[#303030ae]" : "text-[#f5f5f599]"}`}>Create New Properties</div>
