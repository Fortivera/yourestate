...
export default function EditProperty({ property, allProperties: cachedProperties }: Props) {
    ...
    const mutation = useMutation<Property, Error, Property>({
        mutationFn: (newPropertyData: Property) => updateProperty(newPropertyData, property.id),
...
async function updateProperty(userInput: Property, id: number): Promise<Property> {
