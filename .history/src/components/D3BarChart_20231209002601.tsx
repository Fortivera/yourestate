...
export const D3BarChart: React.FC<Props> = ({ allProperties }: Props) => {
    ...
    const createBarChart = (data: Property[]) => {
        ...
        svg.selectAll('.electricity')
            .data(energyTuples)
            .enter()
            .append('rect')
            .attr('class', 'electricity')
            .attr('x', ([country]) => xScale(country) || 0)
        ...
        svg.selectAll('.gas')
            ...
            .append('rect')
            .attr('class', 'gas')
            .attr('x', ([country]) => (xScale(country) || 0) + xScale.bandwidth() / 3)
        ...
        svg.selectAll('.hydro')
            ...
            .append('rect')
            .attr('class', 'hydro')
            .attr('x', ([country]) => (xScale(country) || 0) + (2 * xScale.bandwidth() / 3))
