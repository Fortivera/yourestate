            ...
            <form method="PUT" id="update-form" onSubmit={handleSubmit}>
                <div className={`py-2 px-8 flex flex-col mx-auto border border-t-2 border-b-2 ${theme === "light" ? "border-slate-300" : "bg-[#2f323a] border-[#212329] "} z-1`}>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <NumberInput className={`${theme === "light" ? "bg-white border-2 border-[#9da0a63d] text-black" : "bg-[#767a8572] border-2 border-[#595c653d] text-white"} leading-7 w-full md:w-72 rounded-lg   p-[3px]`} leading-7 w-auto md:w-72 border-b-2`} userDefaultValue={property.tenant} type="number" name="tenant" ariaLabel="Tenants" />
                    </div>
                    <div className="flex flex-col md:flex-row py-2">
