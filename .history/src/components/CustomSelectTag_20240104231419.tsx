...
export const CustomDropdown = ({ options, theme }: any) => {
    ...
    return (
        <div className={"relative block text-left w-full md:w-72"}>
            ...
            {isOpen && (
                <div className={`${theme === "light" ? "bg-white text-black" : "bg-[#595d69fd]  text-white"} z-50 origin-top-right absolute right-0 mt-3 w-full rounded-md shadow-lg  ring-1  ring-gray-100 ring-opacity-10 focus:outline-none`}>
