...
export default function EditProperty({ property }: Props) {
    ...
    const handleDeleteSubmit = async (event: React.MouseEvent<HTMLButtonElement>, property) => {
                ...
                <div className="w-[30rem] py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
                    ...
                    <div className="my-5 ">
                        <div className="flex flexcol items-center justify-center gap-20">
                            <>
                                <button onClick={(event) => handleDeleteSubmit(event, property.id)} className="w-28 rounded-md py-1 shadow-md bg-red-300 hover:bg-red-400 text-black" type="button">
                                    <span>Delete</span>
                                </button>
