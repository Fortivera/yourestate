...
export const D3BarChart: React.FC<Props> = ({ allProperties }: Props) => {
    ...
    const createBarChart = (data: Property[]) => {
        ...
        const highlightEnergyType = (selectedType: string | null) => {
            svg.selectAll(".bar")
                .transition()
                .duration(300)
                .style("opacity", d => selectedType === null || d.type === selectedType ? 1 : 0.1);
        };
        ...
        legend.selectAll("rect")
            ...
            .on("click", type => {
                // Event listener logic (e.g., highlighting or filtering)
            });
        ...
        legend.selectAll("text")
            ...
            .on("click", type => {
                // Similar event listener logic as for the rectangles
            });
