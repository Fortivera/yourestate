        ...
        slice
            ...
            .on("click", function () {
                ...
                if (activeSlice === clickedSlice) {
                    ...
                    g.selectAll("path")
                        .transition()
                        .duration(10) // Set the duration of the transition in milliseconds
                        .style("opacity", 1)
                    activeSlice = null
                } else {
                    // Otherwise, update the active slice and set opacity accordingly with a smooth transition
                    g.selectAll("path").transition().duration(10).style("opacity", 0.5)
                    d3.select(clickedSlice).transition().duration(10).style("opacity", 1)
