...
export default function PropertiesList() {
    ...
    const EmptyDataComponent = () => <div className={`flex justify-center items-center h-40 text-lg italic  ${theme === "light" ? "text-[#303030c3]" : "text-[#f5f5f599]"}`}>Create New Properties</div>
