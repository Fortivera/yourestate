      ...
      <div className="flex items-center  ">
        <div className="flex w-full items-center justify-between gap-8 md:w-auto">
          <div className="flex items-center gap-1 ">
            <Image src="/static/mainlogo.svg" alt="main logo icon" height="40" width="42" className=" md:h-12 md:w-12 pt-[6px] pl-2" />
          </div>
        </div>
      ...
      <div className="flex items-center space-x-5">
        ...
        <Link href={"dashboard/createproperty"}>
          <div className="h-10 flex items-center px-3">
            <div className="m-1">
              <Image src="/static/addproperty.svg" height="24" width="24" alt="add icon" />
            </div>
        ...
        <Link href={"/"}>
          <div className="h-10 flex items-center px-3">
            <div className="m-1">
              <Image src="/static/logout.svg" height="24" width="24" alt="add icon" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round" />
            </div>
