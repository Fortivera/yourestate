...
export default function PropertiesList() {
    ...
    return (
        <>
            <div className={`w-full max-h-[500px] md:max-h-[600px] lg:max-h-[800px] px-1 pt-1 md:border-r-2 ${theme === "light" ? "bg-slate-600/10 border-[#e4e7ec]" : "propertyListDark border-[#536079]"} shadow-neutral-400 shadow-sm overflow-auto`}>
