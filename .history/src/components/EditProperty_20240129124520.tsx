...
export default function EditProperty({ property, allProperties: cachedProperties }: Props) {
    ...
    const updateMutation = useMutation<void, Error, Property>({
        ...
        onSuccess: (data, updatedProperty) => {
            ...
            const updatedCachedProperties = cachedProperties!.map((cachedProperty) => {
                console.log("cached", cachedProperty, "updated", updatedProperty)
                if (cachedProperty.id === Number(updatedProperty.id)) {
                    return { ...cachedProperty, ...updatedProperty, id: cachedProperty.id }
                }
    ...
    async function handleUpdateSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            //checking the types of the data with zod
    ...
    return (
        <Modal>
            ...
            <form method="PUT" id="update-form" onSubmit={handleUpdateSubmit}>
