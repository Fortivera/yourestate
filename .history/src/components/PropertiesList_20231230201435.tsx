...
export default function PropertiesList() {
            ...
            return (
                <>
                    <Suspense fallback={<Loading />}>
                        <li key={property.id} className="py-[0.5rem] border-b-2 last:border-b-0">
    ...
    return (
        <>
            <div className={`w-full h-full pt-1 border-b-2 md:border-r-2 ${theme === "light" ? "bg-slate-600/10" : "propertyListDark"} border-gray-200   shadow-neutral-400 shadow-sm overflow-auto`}>
