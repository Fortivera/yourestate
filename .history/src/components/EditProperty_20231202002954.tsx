  ...
  return (
    <Modal>
      ...
      <form method="PUT" id="update-form" onSubmit={handleSubmit}>
        <div className="max-w-[30rem] py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1 sm:flex-row sm:flex-wrap">
          ...
          <div className="flex py-2">
            ...
            <select name="Type" id="Property type" className={`leading-7 w-72 border-b-2 ${theme === "light" ? "bg-white" : inputColour} `} defaultValue={property.type}>
