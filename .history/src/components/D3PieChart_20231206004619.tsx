    ...
    const createPieChart = (data: Property[]) => {
        ...
        const slice = g.selectAll('g')
            ...
            .on('mouseover', function (this: SVGElement, d) {
                ...
                const originalColor = slice.attr('fill'); // Store the original color

                slice.attr('fill', 'orange'); // Change the color on hover
            ...
            .on('mouseout', function () {
                ...
                slice.attr('fill', originalColor); // Set the fill back to the original color
