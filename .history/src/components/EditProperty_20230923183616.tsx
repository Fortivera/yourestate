...
export default function EditProperty({ property }: Props) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const formData = new FormData(dataCollected) as Iterable<
      ...
      >
        <div className="w-[30rem] py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
          ...
          <input
            ...
            type="text"
            name="id"
            className={`${theme === "light" ? "bg-white" : inputColour} `}
          />
          <div className="flex py-2">
            ...
            <select
              name="Type"
              id="Property type"
              className={`border-2 w-72 ${theme === "light" ? "bg-white" : inputColour
                } `}
          ...
          <div className="flex py-2 ">
            ...
            <input
              className={`leading-7 w-72 border-b-2 ${theme === "light" ? "bg-white" : inputColour
                }`}
              id=""
              type="text"
              name="Address"
          ...
          <div className="flex py-2">
            ...
            <input
              className={`${theme === "light" ? "bg-white" : inputColour
                } leading-7 w-72 border-b-2`}
              id=""
              type="text"
              name="Suite"
              aria-label="Suite"
              defaultValue={property.suite}
            />
          </div>
          <div className="flex py-2">
            <label
          ...
          <div className="flex py-2">
            ...
            <input
              ...
              defaultValue={property.surfaceArea}
            />
          </div>
          <div className="flex py-2">
            <label
          ...
          <div className="flex py-2">
            ...
            <input
              ...
              defaultValue={property.electricity}
            />
          </div>
          <div className="flex py-2">
            <label
          ...
          <div className="flex py-2">
            ...
            <input
              ...
              name="Gas"
              aria-label="Gas"
              defaultValue={property.gas} pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"
            />
          </div>
          <div className="my-5 ">
            <div className="flex flexcol items-center justify-center gap-20">
              <>
                <button
                  ...
                  className="w-28 rounded-md py-1 shadow-md bg-red-300 hover:bg-red-400 text-black"
                  type="button"
                >
                  <span>Delete</span>
                </button>
