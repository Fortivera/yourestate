    ...
    return (
        <nav className={`${theme === "light" ? "navbarLight" : "navbarDark"} flex font-Noto text-lg shadow-sm shadow-slate-100`}>
            <div className="flex items-center justify-center">
                <svg width="208" height="52" xmlns="http://www.w3.org/2000/svg" overflow="hidden" stroke="currentColor" fill="none"><g transform="translate(-284 -50)"><text font-family="Calibri,Calibri_MSFontService,sans-serif" font-weight="400" font-size="24" transform="translate(299.215 80)">YourEstat</text><text font-family="Calibri,Calibri_MSFontService,sans-serif" font-weight="400" font-size="24" transform="translate(390.215 80)">e</text></g></svg>
            </div>
