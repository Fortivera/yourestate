...
export default function PropertiesList() {
    ...
    return (
        <>
            <div className={`w-full h-full pt-1 border-b-2 md:border-r-2 ${theme === "light" ? "bg-slate-600/10" : "bg-neutral-900/30"} border-gray-200   shadow-neutral-400 shadow-sm overflow-auto`}>
