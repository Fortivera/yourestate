...
export default function ThemeToggle() {
    ...
    return (
        <>
            ...
            <div className="flex items-center w-14 h-6 rounded-full cursor-pointer justify-between  relative" onClick={toggle} className={theme === "dark" ? { backgroundColor: "white" } : { backgroundColor: "#0f172a" }}>
