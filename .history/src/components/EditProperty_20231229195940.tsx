        ...
        onSuccess: (data: any, variables: Property) => {
            ...
            const updatedCachedProperties = cachedProperties!.map((p) => {
                ...
                if (p.id === Number(updatedProperty.id)) {
                    p.id = p.id as number
                    p.type = updatedProperty.type as string
                    p.address = updatedProperty.address as string
                    p.city = updatedProperty.city as string
                    p.suite = updatedProperty.suite as string
                    p.postalCode = updatedProperty.postalCode as string
                    p.province = updatedProperty.province as string
                    p.country = updatedProperty.country as string
                    p.tenant = updatedProperty.tenant as number
                    p.rent = updatedProperty.rent as number
                    p.surfaceArea = updatedProperty.surfaceArea as number
                    p.age = updatedProperty.age as number
                    p.electricity = updatedProperty.electricity as number
                    p.hydro = updatedProperty.hydro as number
                    p.gas = updatedProperty.gas as number
