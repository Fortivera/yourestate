            ...
            {formLabels.map((entity: any) => {
                return (
                    <div key={entity.id} className="flex flex-col md:flex-row py-2 ">
                        ...
                        <input
                            className={`${theme === "light" ? "bg-white" : inputColour} leading-7 w-auto md:w-72 border-b-2 ${touchedFields[entity.name] && event?.target && (event.target as HTMLInputElement).value.trim() === ''
