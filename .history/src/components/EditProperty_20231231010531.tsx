            ...
            <form method="PUT" id="update-form" onSubmit={handleSubmit}>
                <div className={`py-2 px-8 flex flex-col mx-auto border border-t-2 border-b-2 ${theme === "light" ? "border-slate-300" : "bg-[#2f323a] border-[#212329] "} z-1`}>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <select name="type" id="Property type" className={`w-auto md:w-72 leading-7 border-b-2 rounded-md ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring-2 focus:ring-indigo-600 focus:border-transparent`} defaultValue={property.type}>
                            {/* options */}
                        </select>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`leading-7 w-auto md:w-72 border-b-2 rounded-md ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring-2 focus:ring-indigo-600 focus:border-transparent`} id="" type="text" name="address" aria-label="Address" defaultValue={property.address} />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row py-2">
                        ...
                        <input className={`leading-7 w-auto md:w-72 border-b-2 rounded-md ${theme === "light" ? "bg-white" : "bg-[#2f323a] text-white"} focus:ring-2 focus:ring-indigo-600 focus:border-transparent`} id="" type="text" name="suite" aria-label="Suite" defaultValue={property.suite} />
                    </div>
                    <div className="flex flex-col md:flex-row py-2">
