...
export const CustomDropdown = ({ options, theme }: any) => {
    ...
    return (
        <div className="relative inline-block text-left w-auto md:w-72">
            ...
            {isOpen && (
                <div name="type" className="origin-top-right absolute right-0 mt-2 w-full rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
