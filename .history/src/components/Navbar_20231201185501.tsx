...
export default function Navbar() {
    ...
    return (
        <nav className={`${theme === "light" ? "navbarLight" : "navbarDark"} font-Noto text-lg shadow-sm shadow-slate-100 flex items-center justify-between gap-5`}>
            ...
            {/* Burger Menu */}
            <button className="block md:hidden cursor-pointer p-2" onClick={handleMenuToggle}>
            ...
            <div className={`md:hidden ${menuOpen ? "block" : "hidden"} space-y-3`}>
                <ThemeToggle />
                <Link href={"dashboard/createproperty"}>
                    <div className="h-10 flex items-center px-3">
                        <SvgAddProperty className="m-1" strokeWidth={1.5} />
