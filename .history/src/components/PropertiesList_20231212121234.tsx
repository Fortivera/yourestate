...
export default function PropertiesList({ allProperties }: Props) {
    ...
    const showAllProperties =
        ...
        allProperties.map((property: Property) => {
            return (
                <>
                    <Suspense key={property.id} fallback={<div>Loading properties...</div>}>
                        <li className="border-b-2 last:border-b-0">
    ...
    const showSearchedProperties =
        ...
        allProperties
            ...
            .map((filteredProperty: Property) => {
                ...
                return (
                    <>
                        <Suspense key={filteredProperty.id} fallback={<div>Loading properties...</div>}>
                            <li>
