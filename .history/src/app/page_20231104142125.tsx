...
export default function Login() {
  return (
    <section className="min-h-screen bg-gray-50 flex items-center justify-center">
      {/* login container */}
      <div className="px-4 py-10 rounded-lg tablet:w-[540px] laptop:w-[1000px] laptop:flex laptop:flex-row laptop:space-x-8 bg-blue-100">
        {/* image */}
        <figure className="w-1/2 laptop:w-[2000px]  tablet:w-full">
          <Image src={growthVisual} alt="login page picture" layout="responsive" />
        </figure>
        {/* login form */}
        <div className="w-1/2 px-4 pb-8 pt-2 bg-white border rounded-lg shadow-md">
