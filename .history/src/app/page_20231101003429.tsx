        ...
        <div className="w-full px-4 pb-8 pt-2 bg-white border rounded-lg shadow-md">
          ...
          <div className="mb-4 relative">
            <label className="text-sm" htmlFor="Name">
              <Image src="/static/name.svg" alt="user icon" width={18} height={10} className="absolute left-3 top-2" />
            </label>
          ...
          <div className="mb-4 relative">
            <label className="text-sm" htmlFor="Password">
              <Image src="/static/password.svg" alt="password icon" width={18} height={10} className="absolute left-3 top-2" />
            </label>
