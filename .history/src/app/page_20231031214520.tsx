  ...
  return (
    <>
      <form method="get" id="login-form">
        ...
        <div className="h-screen w-72 bg-gray-50 flex items-center justify-center">
          <div className="flex flex-row">
            <Image src={"/static/growth.jpg"} alt={"login page picture"} width={500} height={700} className={"m-3 absolute "} />
          </div>
          <div className="bg-white border rounded-lg shadow-md p-8  w-[1000px] mx-2">
