    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="flex justify-center items-center w-full px-4 py-10 tablet:w-[540px] ">
        <div className="flex laptop:flex-row tablet:flex-col mobile:flex-col">
          ...
          <div className="w-[400px] px-4 pb-6 pt-5 bg-white border rounded-lg shadow-md">
            ...
            <button type="button" aria-label="Sign-in button" className="bg-[#5392f7] text-white rounded-lg w-2/3 py-2 mb-4 hover:bg-[#3b83f6]">
