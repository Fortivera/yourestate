...
export default function Login() {
  return (
    <section className="min-h-screen bg-gray-50 flex items-center justify-center">
      {/* login container */}
      <div className="flex flex-col tablet:flex-row bg-white rounded-2xl shadow-lg max-w-screen- desktop">
        {/* image */}
        <figure className="mobile:w-[60%] p-5">
          <Image src={growthVisual} alt="login page picture" className="rounded-2xl" />
        </figure>
        {/* login form */}
        <form className="flex flex-col items-center mobile:w-[40%] rounded-lg p-5 ">
          ...
          <div className="w-full mt-10 mb-4 relative">
            ...
            <input defaultValue="admin" id="Name" type="text" name="Name" placeholder="Username" autoComplete="given-name" required className="block w-20 border rounded-lg py-2 pl-9 mt-1 focus:ring focus:ring-blue-300" />
          </div>
