      ...
      <div className="">
        ...
        <div className="w-full px-4 pb-8 pt-2 bg-white border rounded-lg shadow-md">
          ...
          <div className="mb-4 relative">
            ...
            <input defaultValue="admin" id="Name" type="text" name="Name" placeholder="Username" autoComplete="given-name" required className="absolute block w-full border rounded-lg py-2 pl-9 mt-1 focus:ring focus:ring-blue-300" />
          </div>
          ...
          <div className="mb-4 relative">
            ...
            <input defaultValue="admin" id="Password" type="password" name="Password" placeholder="Password" required className="block w-full border rounded-lg py-2 pl-9 mt-1 focus:ring focus:ring-blue-300 absolute" />
          </div>
