                ...
                return (
                  <>
                    <Link href={`/dashboard/${property.id}`}>
                      <Property key={property.id} City={property.City} id={0} Type={""} Address={""} Suite={""} PostalCode={""} Province={""} Country={""} Tenant={0} Rent={0} SurfaceArea={0} Age={0} Electricity={0} Hydro={0} Gas={0} />
                    </Link>
                  </>
                )
              }
