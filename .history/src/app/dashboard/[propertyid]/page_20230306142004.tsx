            ...
            <form method="post" id="property-form" onSubmit={onSubmit}>
                <div className="  w-96 py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
                    ...
                    <div className="flex py-2">
                        ...
                        <div className="leading-7 w-72 border-b-2" id="" name="PostalCode" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >City</div>
                        <div className="leading-7 w-72 border-b-2" id="" name="City" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >Province</div>
                        <div className="leading-7 w-72 border-b-2" id="" name="Province" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >Country</div>
                        <div className="leading-7 w-72 border-b-2" id="" name="Country" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >Number of Tenants</div>
                        <div className="leading-7 w-72 border-b-2" id="" type="number" name="Tenant" />
                    </div>
                    <div className="flex py-2">
                        ...
                        <div className="leading-7 w-72 border-b-2" id="" type="number" name="Rent" div>
                            <div className="flex py-2">
                                ...
                                <div className="leading-7 w-72 border-b-2" id="" type="number" name="SurfaceArea" " ^2)" />
                            </div>
                            <div className="flex py-2">
                                <div className="pr-3 w-52" >Age</div>
                                <div className="leading-7 w-72 border-b-2" id="" type="number" name="Age" />
                            </div>
                            <div className="flex py-2">
