...
export default function EditProperty({ property }: any) {
    ...
    function handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        const requestData: Property = await Object.fromEntries(formData)
    ...
    return (
        <Modal>
            <form method="PUT" id=" " onSubmit={handleSubmit}>
