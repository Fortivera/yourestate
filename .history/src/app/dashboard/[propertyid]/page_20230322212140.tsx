...
export default function ShowProperty({ params: { propertyid } }: Params) {
    ...
    const objectData = useProperties((state) => state.allProperties) as unknown as objAllProperties
    const allProperties = objectData.collection as unknown as Property[]
