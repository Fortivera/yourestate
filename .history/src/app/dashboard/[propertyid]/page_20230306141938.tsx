            ...
            <form method="post" id="property-form" onSubmit={onSubmit}>
                <div className="  w-96 py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
                    <div className="flex py-2">
                        ...
                        <div name="Type" id="Property type" className="border-2 w-72">

                        </div>
                    </div>
                    <div className="flex py-2 ">
                        <div className="pr-3 w-52 ">Address</div>
                        <div className="leading-7 w-72 border-b-2" id="" placeholder="Address" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >Suite</div>
                        <div className="leading-7 w-72 border-b-2" id="" placeholder="Suite" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >PostalCode</div>
                        <div className="leading-7 w-72 border-b-2" id="" name="PostalCode" placeholder="PostalCode" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >City</div>
                        <div className="leading-7 w-72 border-b-2" id="" name="City" placeholder="City" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >Province</div>
                        <div className="leading-7 w-72 border-b-2" id="" name="Province" placeholder="Province" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >Country</div>
                        <div className="leading-7 w-72 border-b-2" id="" name="Country" placeholder="Country" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >Number of Tenants</div>
                        <div className="leading-7 w-72 border-b-2" id="" type="number" name="Tenant" placeholder="Tenants" />
                    </div>
                    <div className="flex py-2">
                        <div className="pr-3 w-52" >Rent</div>
                        <div className="leading-7 w-72 border-b-2" id="" type="number" name="Rent" div>
                            <div className="flex py-2">
                                <div className="pr-3 w-52" >Surface Area</div>
                                <div className="leading-7 w-72 border-b-2" id="" type="number" name="SurfaceArea" " placeholder="Area (ft^2)" />
                            </div>
                            <div className="flex py-2">
                                <div className="pr-3 w-52" >Age</div>
                                <div className="leading-7 w-72 border-b-2" id="" type="number" name="Age" placeholder="Age" />
                            </div>
                            <div className="flex py-2">
                                <div className="pr-3 w-52" >Electricity</div>
                                <div className="leading-7 w-72 border-b-2" id="" type="number" name="Electricity" />
                            </div>
                            <div className="flex py-2">
                                <div className="pr-3 w-52" >Hydro</div>
                                <div className="leading-7 w-72 border-b-2" id="" type="number" name="Hydro" />
                            </div>
                            <div className="flex py-2">
