...
export default function ShowProperty({ params: { propertyid } }: Params) {
    ...
    return (
        <EditProperty id={property.id} type={property.type} address={property.address} city={""} suite={""} postalCode={""} province={""} country={""} tenant={0} rent={0} surfaceArea={0} age={0} electricity={0} hydro={0} gas={0} />
    )
}
