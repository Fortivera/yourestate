                ...
                <div className="w-96 py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
                    ...
                    <div className="my-5 ">
                        <div className="flex flexcol items-center justify-center gap-20">
                            <button className="w-28   rounded-md py-1 bg-red-300 shadow-md hover:bg-red-600">
                                <Link href={"/dashboard"}>Delete</Link>
                            </button>

                            <button className="w-28 bg-yellow-300 rounded-md py-1 hover:bg-yellow-400 shadow-md" type="submit">
                                <span>Submit</span>
                            </button>
                        </div>
                    </div>
