                ...
                <div className="w-[30rem] py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
                    ...
                    <div className="my-5 ">
                        <div className="flex flexcol items-center justify-center gap-20">
                            <button onClick={() => handleDelete()} className="w-28 rounded-md py-1 bg-red-300 shadow-md hover:bg-red-400" type="button">
                                <Link href={'/dashboard'}>Delete</Link>
                            </button>

                            <button onClick={() => handlePut()} className="w-28 bg-indigo-200 rounded-md py-1 hover:bg-indigo-300 shadow-md" type="submit">
