      ...
      <form method="POST" id="property-form" onSubmit={postHandler}>
        <div className="py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
          ...
          <div className="flex flex-col md:flex-row py-2">
            ...
            <input className={`${theme === "light" ? "bg-white" : inputColour} leading-7 w-auto md:w-72 border-b-2`} id="" type="text" name="City" aria-label="City" placeholder={"city" || validInput} />
          </div>
          <div className="flex flex-col md:flex-row py-2">
          ...
          <div onChange={checkInput} className="flex flex-col md:flex-row py-2">
