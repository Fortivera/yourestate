...
export default function NewProperty() {
  ...
  const mutation = useMutation<void, Error, Property>({
    ...
    onSuccess: (data, createdProperty) => {
      console.log("the createdprprorproperty", createdProperty)asdfasdfasdfasd
  ...
  async function postHandler(event: FormEvent<HTMLFormElement>) {
    ...
    const parsedData = zodPropertySchema.safeParse(Object.fromEntries(new FormData(formElement)));
