...
export default function NewProperty() {
    ...
    function checkInput(event: React.ChangeEvent<HTMLInputElement>) {
        ...
        if (type === "text" && !!value.match(/^[a-zA-Z\s]+$/)) {
            setValidIput("Please insert a text value")
        } else {
            setValidIput("Please insert a number value")
        }
        s
    }
    ...
    return (
        <Modal>
            ...
            <form method="POST" id="property-form" onChange={checkInput} onSubmit={postHandler}>
