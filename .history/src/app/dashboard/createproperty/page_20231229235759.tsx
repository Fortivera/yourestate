...
import { cache, ChangeEvent, FormEvent, useState } from "react"
...
export default function NewProperty() {
    const cachedProperties = useQueryClient().getQueryData(["allProperties"]) as Property[]
    ...
    const mutation = useMutation<void, Error, Property>({
        ...
        onSuccess: (data, createdProperty) => {
            const createdPropertya = cachedProperties.map((p) => {
                if (p.id === createdProperty.id) {
