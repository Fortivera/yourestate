        ...
        <div className="w-[30rem] py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
          ...
          <div className="my-5 ">
            <div className="flex flexcol items-center justify-center gap-20">
              <button
                type="button"
                className="w-28 rounded-md py-1 shadow-md hover:bg-red-400 bg-white text-black"
              >
                <Link href={"/dashboard"}>Cancel</Link>
              </button>

              <button
                className="w-28 bg-indigo-200 rounded-md py-1 hover:bg-indigo-300 shadow-md text-black"
                type="submit"
              >
                Submit
              </button>
...
async function postData(userInput: Property) {
  ...
  try {
    ...
    alert(`We can't submit the form, due to ${content}`)
  }
}
