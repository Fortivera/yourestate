...
export default function NewProperty() {
    ...
    async function submitStateHandler() {
        await postHandler
    }
                ...
                <div className="py-2 px-8 flex flex-col mx-auto border-2 border-gray-400 z-1">
                    ...
                    <div className="my-5 ">
                        <div className="flex flexcol items-center justify-center gap-20">
                            ...
                            <button onClick={async () => await submitStateHandler} className="w-28 bg-indigo-200 rounded-md py-1 hover:bg-indigo-300 shadow-md text-black" type="submit">
                                Submit
                            </button>
                        </div>
                    </div>
