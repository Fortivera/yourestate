...
export default function Login() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
      <div className="w-full max-w-[90%] desktop:max-w-[80%] xl:max-w-[60%] 2xl:max-w-[50%] flex flex-col-reverse desktop:flex-row-reverse items-center">
        <div className="w-full h-[300px] desktop:w-[400px] desktop:h-[400px] relative order-2 desktop:order-1">
          <Image src="/static/growth.jpg" alt="login page picture" layout="fill" objectFit="cover" />
        </div>
        <div className="w-full desktop:w-[400px] px-4 pb-8 pt-2 order-1 desktop:order-2 bg-white border rounded-lg shadow-md">
