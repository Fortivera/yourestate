...
export default function Login() {
  return (
    <section className="min-h-screen bg-gray-50 flex items-center justify-center">
      {/* login container */}
      <div className="flex bg-blue-100 bg-white border  shadow-md">
        {/* image */}
        <figure className="w-1/2 rounded-lg p-5 bg-white border  shadow-md">
          <Image src={growthVisual} alt="login page picture" layout="responsive" />
        </figure>
        {/* login form */}
        <div className="w-1/2 rounded-lg p-5 bg-white border  shadow-md">
