...
export default function Login() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="w-full h-[1000px] px-4 py-10 tablet:w-[540px] laptop:w-[1000px] laptop:flex laptop:flex-row laptop:space-x-8">
        <figure className="laptop:w-full tablet:w-full">
          <Image src={growthVisual} alt="login page picture" layout="responsive" className="w-full" />
        </figure>
