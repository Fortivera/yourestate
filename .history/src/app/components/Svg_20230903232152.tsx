...
export const SearchIcon = () => {
  let style: string
  return (
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="632.399px" height="632.399px" viewBox="0 0 632.399 632.399" style={{ enableBackground: "new 0 0 632.399 632.399" }} xmlSpace="preserve">
      <g>
        <path
...
;<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#838383">
  ...
  <g id="SVGRepo_iconCarrier">
    ...
    <line x1="44" y1="44" x2="33.66" y2="33.66"></line>
  </g>
</svg>
