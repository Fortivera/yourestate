...
export const SearchIcon = () => {
  let style: string
  return (
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="632.399px" height="632.399px" viewBox="0 0 632.399 632.399" style={{ background: "new 0 0 632.399 632.399" }} xmlSpace="preserve">
      <g>
        <path
