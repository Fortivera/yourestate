        ...
        <div className="bg-white border rounded-lg shadow-md p-8 max-w-xs w-full mx-2">
          ...
          <div className="mb-4 ">
            <label htmlFor="Email" className="">
              <Image src="/static/email.svg" alt={"moon icon"} width={18} height={10} className={"m-3 absolute "} />
            </label>
          ...
          <div className="mb-4">
            <label className="text-sm" htmlFor="Password">
              <Image src="/static/.svg" alt={"moon icon"} width={18} height={10} className={"m-3 absolute "} />
            </label>
