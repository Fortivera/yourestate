...
export default function Registration() {
    ...
    const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        var e = event.target as HTMLFormElement
        const data = new FormData(e) as unknown as Iterable<[RequestData, FormDataEntryValue]>
        const requestData: RequestData = Object.fromEntries(data);
