                ...
                <div className="bg-white border rounded-lg shadow-md p-8 max-w-xs w-full mx-2">
                    ...
                    <div className="mb-4 relative">
                        <label htmlFor="Email" className="">
                            <SvgEmail width={18} height={10} className={"absolute left-3 top-3"} />
                            <Image src="/static/email.svg" alt={"moon icon"} width={18} height={10} className={"absolute left-3 top-3"} />
                        </label>
                    ...
                    <div className="mb-4 relative">
                        <label className="text-sm" htmlFor="Name">
                            <Image src="/static/name.svg" alt={"moon icon"} width={18} height={10} className={"absolute left-3 top-3"} />
                        </label>
                        <input id="Name" name="Name" type="text" placeholder="Name" required className="block w-full border rounded-lg py-2 pl-9 mt-1 focus:ring focus:ring-blue-300" />
                    </div>

                    <div className="mb-4 relative">
                        <label className="text-sm" htmlFor="Password">
                            <Image src="/static/password.svg" alt={"moon icon"} width={18} height={10} className={"absolute left-3 top-3"} />
                        </label>
                        <input id="Password" name="Password" type="password" placeholder="Password" pattern="[a-z0-9]{1,15}" title="Password should be digits (0 to 9) or alphabets (a to z)." required className="block w-full border rounded-lg py-2 pl-9 mt-1 focus:ring focus:ring-blue-300" />
                    </div>
