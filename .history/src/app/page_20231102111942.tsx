...
export default function Login() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="flex justify-center w-full px-4 py-10 tablet:w-[540px] laptop:w-[1000px]">
        <div className="flex laptop:flex-row tablet:flex-col mobile:flex-col">
          <figure className="max-w-[400px]  ">
            <Image src="/static/growth.jpg" alt="login page picture" layout="responsive" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
          </figure>
