...
export default function Login() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="w-full max-w-[90%] desktop:max-w-[80%] xl:max-w-[60%] 2xl:max-w-[50%] flex flex-col desktop:flex-row items-center">
        <div className="w-full desktop:w-[400px] px-4 pb-8 pt-2 desktop:pb-0 desktop:pt-0  bg-white border rounded-lg shadow-md">
