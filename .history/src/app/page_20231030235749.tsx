        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="bg-white border rounded-lg shadow-md p-8 max-w-xs w-full mx-2">
            ...
            <div className="mb-4">
              ...
              <input defaultValue={"admin"} id="Name" type="text" name="Name" placeholder="Username" autoComplete="given-name" required className="block w-full border rounded-lg px-3 py-2 mt-1 focus:ring focus:ring-blue-300" />
            </div>
            ...
            <div className="mb-4">
              ...
              <input defaultValue={"admin"} id="Password" type="password" name="Password" placeholder="Password" required className="block w-full border rounded-lg px-3 py-2 mt-1 focus:ring focus:ring-blue-300" />
            </div>

            <button type="button" aria-label="Sign-in button" className="bg-[rgb(59 130 246 / 0.5)] text-white rounded-lg w-full py-2 mb-4 hover:bg-blue-100">
              <Link href="/dashboard">Login</Link>
            </button>
