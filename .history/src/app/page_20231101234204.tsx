...
export default function Login() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="w-full px-4 py-10 tablet:w-[540px] laptop:w-[1000px]">
        <div className="tablet:flex tablet:flex-col laptop:flex-row">
          ...
          <div className="w-[500px] px-4 pb-8 pt-2 bg-white border rounded-lg shadow-md">
